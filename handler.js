...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.wm = '© V-BOTZ'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'V-BOTZ'
        global.kontak2 = [
        ['6285760165734', 'Vanzz', '𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 𝑩𝒐𝒕', 'https://Instagram.com/vanzzxyt.official', true],
        ['6282235537809', await this.getName('6282235537809@s.whatsapp.net'), 'Co-Owner', 'https://instagram.com/wirzz_turu', true], 
        ]
